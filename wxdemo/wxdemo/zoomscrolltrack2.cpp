...
IMPLEMENT_CLASS( ZoomScrollTrack2, wxDialog )

/*
 * ZoomScrollTrack2 event table definition
 */

BEGIN_EVENT_TABLE( ZoomScrollTrack2, wxDialog )
  ...
  EVT_CHECKBOX(ID_ALPHA_CB, ZoomScrollTrack2::OnSelectDataSeries )
  EVT_CHECKBOX(ID_BETA_CB, ZoomScrollTrack2::OnSelectDataSeries )
  EVT_CHECKBOX(ID_GAMMA_CB, ZoomScrollTrack2::OnSelectDataSeries )
...
{    
  ...
  m_alphaCheckBox = new wxCheckBox(itemPanel2, ID_ALPHA_CB, _("Alpha Series"), wxDefaultPosition, wxDefaultSize, 0);
  m_alphaCheckBox->SetValue(true);
  itemStaticBoxSizer1->Add(m_alphaCheckBox, 0, wxALIGN_LEFT | wxALL, FromDIP(3));
  m_betaCheckBox = new wxCheckBox(itemPanel2, ID_ALPHA_CB, _("Beta Series"), wxDefaultPosition, wxDefaultSize, 0);
  m_betaCheckBox->SetValue(true);
  itemStaticBoxSizer1->Add(m_betaCheckBox, 0, wxALIGN_LEFT | wxALL, FromDIP(3));
  m_gammaCheckBox = new wxCheckBox(itemPanel2, ID_ALPHA_CB, _("Gamma Series"), wxDefaultPosition, wxDefaultSize, 0);
  m_gammaCheckBox->SetValue(true);
  itemStaticBoxSizer1->Add(m_gammaCheckBox, 0, wxALIGN_LEFT | wxALL, FromDIP(3));
  itemStaticBoxSizer1->Add(3, 3, 1, wxALIGN_CENTER_HORIZONTAL | wxALL, FromDIP(3));

  wxStaticText* itemStaticText3 = new wxStaticText(itemPanel2, wxID_STATIC, _("Start date"), wxDefaultPosition, wxDefaultSize, 0);
  itemStaticBoxSizer1->Add(itemStaticText3, 0, wxALIGN_LEFT | wxLEFT | wxRIGHT | wxTOP, FromDIP(3));

   m_startDate = new wxDatePickerCtrl(itemPanel2, ID_DATE_START, wxDateTime(), wxDefaultPosition, wxDefaultSize, wxDP_DROPDOWN);
  itemStaticBoxSizer1->Add(m_startDate, 0, wxEXPAND | wxALL, FromDIP(3));

  itemStaticBoxSizer1->Add(3, 3, 0, wxALIGN_CENTER_HORIZONTAL | wxALL, FromDIP(3));

  wxStaticText* itemStaticText6 = new wxStaticText(itemPanel2, wxID_STATIC, _("End date"), wxDefaultPosition, wxDefaultSize, 0);
  itemStaticBoxSizer1->Add(itemStaticText6, 0, wxALIGN_LEFT | wxLEFT | wxRIGHT | wxTOP, FromDIP(3));

  m_endDate = new wxDatePickerCtrl(itemPanel2, ID_DATE_END, wxDateTime(), wxDefaultPosition, wxDefaultSize, wxDP_DROPDOWN);
  itemStaticBoxSizer1->Add(m_endDate, 0, wxEXPAND | wxALL, FromDIP(3));
...
ZoomScrollTrack2::DrawChart(wxChartViewer* viewer)
{
  ...
  if (m_alphaCheckBox->IsChecked())
    layer->addDataSet(viewPortDataSeriesA, 0xff3333, "Alpha");
  if (m_betaCheckBox->IsChecked())
    layer->addDataSet(viewPortDataSeriesB, 0x008800, "Beta");
  if (m_gammaCheckBox->IsChecked())
...
//
void ZoomScrollTrack2::OnSelectDataSeries(wxCommandEvent& event)
{
  m_chartViewer->updateViewPort(true, true);
}
