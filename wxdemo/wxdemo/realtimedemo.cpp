...
IMPLEMENT_CLASS( RealTimeDemo, wxDialog )

/*
 * RealTimeDemo event table definition
 */

BEGIN_EVENT_TABLE( RealTimeDemo, wxDialog )
...
RealTimeDemo::DrawChart()
{
  ...
  c->addTitle("Field Intensity at Observation Satellite", "Times New Roman Bold Italic", 15)->setBackground(0xdddddd, 0x000000, Chart::glassEffect());
