...
IMPLEMENT_CLASS( ViewportControlDemo, wxDialog )

/*
 * ViewportControlDemo event table definition
 */

BEGIN_EVENT_TABLE( ViewportControlDemo, wxDialog )
...
{    
  ...
  m_chartViewer->SetMinSize(FromDIP(wxSize(660, 400)));
  ...
  m_viewPortControl->SetMinSize(FromDIP(wxSize(660, 70)));
