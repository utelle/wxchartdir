...
class ZoomScrollTrack2 : public wxDialog
{    
...
public:
  ...
  /// wxEVT_COMMAND_CHECKBOX_CLICKED event handler for ID_ALPHA_CB, ID_BETA_CB, ID_GAMMA_CB
  void OnSelectDataSeries(wxCommandEvent& event);
  ...
  wxCheckBox* m_alphaCheckBox;
  wxCheckBox* m_betaCheckBox;
  wxCheckBox* m_gammaCheckBox;
  wxColour          m_bgColour;
